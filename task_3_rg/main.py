...
from task_3_rg.utils.visualization import plot_chart_train_phase, \
    ...
    visualize_embeddings_1d, visualize_embeddings_2d, visualize_decision_boundary_2d, plot_embeddings_regression
...
def main(mode: int):
    ...
    if mode == 1:
        ...
        train_los, val_los, acc_metr, prec_metr, recc_metr, f1_metr = train_evaluate_save_model(model, criterion, optimizer, train_loader=train_loader,
                                  ...
                                  epochs=num_epochs, device=device, best_model_path=qm9_model_path,
                                  patience=patience)
        ...
        visualize_embeddings_2d(embeddings, labels, title="BACE 2D Embedding Visualisation")
        ...
        train_los, val_los, mae_met = train_evaluate_save_model_regression(model, criterion,optimizer,
                                                                                ...
                                                                                epochs=num_epochs,
                                                                                device=device,
                                                                                best_model_path=bace_model_path,
                                                                                patience=patience)
